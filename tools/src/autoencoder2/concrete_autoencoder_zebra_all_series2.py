...
class ConcreteAutoencoder(pl.LightningModule):
    def __init__(
        ...
        """Trains a concrete autoencoder. Implemented according to [_Concrete Autoencoders for Differentiable Feature Selection and Reconstruction_](https://arxiv.org/abs/1901.09346). Trains a network to estimate the parameters of a specified model (ZEBRA as default) and predict the signal following the model
